...
public class ValidMailPass {
    ...
    public void testValidMailPass() throws Exception {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div/div/div[1]/div/form/div/div[6]/div/input")).sendKeys("123456");

        driver.findElement(By.id("id-password-login-button")).click();
        WebDriverWait wait = new WebDriverWait(driver, 30);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("app-account-menu")));
